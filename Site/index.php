...
<body>
    <header>
        <div class="container-top">
            <div class="flex">
                <a href="index.html"><img src="imagens/logo.png" width="80px" height="70px" alt="" class="image-container-top"></a>
                <nav>
                    <ul>
    ...
    <section class="banner">
        <img class="banner-image" src="imagens/teste.webp" alt="">
    </section>
<br>
    <section class="image-with-text">
        <div class="image-container">
            <img src="imagens/carrocel2.jpg" alt="Descrição da imagem">
        </div>
   ...
   <br><br id="especialidades" > 
    ...
    <section class="image-with-text">
        <div class="image-container">
            <img src="imagens/ca2.jpg"  alt="Descrição da imagem">
        </div>
        <div class="text-container" >
            <h1 >Quem Somos</h1>
    ...
    <div id="carouselExampleInterval"class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000" data-bs-pause="false">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="imagens/mg1.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="imagens/mg2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="imagens/mg3.jpg" class="d-block w-100" alt="...">
            </div>
            ...
            <div class="text-container2">
                ...
                <div class="btn-contato2">
                    <a href="#"><button class="btnhover">Agendar Consulta</button></a>
                </div>
            </div>
    ...
    <div class="centered-image">
        <img src="imagens/logo.png" width="120px" alt="Descrição da imagem" id="contato">
    </div>
